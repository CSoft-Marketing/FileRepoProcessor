...
namespace FileRepoProcessor
{
    ...
    new(StringComparer.OrdinalIgnoreCase)
    {
        ...
        ".txt", ".text", ".csv", ".log", ".asc", ".tsv", ".ini", ".cfg", ".config", ".properties", ".env",
        ".json", ".xml", ".xaml", ".yaml", ".yml", ".md", ".markdown", ".rst", ".tex", ".css", ".js", ".ts",
        ".jsx", ".tsx", ".c", ".cpp", ".h", ".hpp", ".cs", ".vb", ".java", ".kt", ".swift", ".go", ".py", ".rb",
        ".php", ".pl", ".lua", ".r", ".m", ".scala", ".groovy", ".dart", ".pas", ".f90", ".asm", ".s", ".bat", ".cmd",
        ".psl", ".sh", ".gitignore", ".gitattributes", ".editorconfig", ".dockerignore",".npmrc", ".gitmodules",
        ".csproj", ".vbproj", ".fsproj", ".props", ".targets", ".sln", ".manifest",
        ".htm", ".html", ".xhtml",
        ".eml",".msg"
    };
        public void Start()
